...
- [x] Monitor the temperature of the meat
    - [x] Monitor at least two temperatures
    - [x] Set the temperature of the meat to reach
...
- [ ] Have pre-defined cooking profiles
  ...
  - [ ] Custom page profile
- [x] Can control the smoker heating element
- [x] Can control the smoker fan
  - [x] Control the speed of the fan 
- [x] Can control the smoker smoke generator
  - [x] Control on and off 
